...
activities = {
    ...
    "Soccer Club": {
        "description": "Outdoor training and friendly soccer matches",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, plan performances, and build stage skills",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "mason@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Work on advanced math problems and prepare for competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
